<div class="row-fluid reg">
      ...
      <strong>Your </strong>Registration successfully completed .we will touch with you soon.....
    </div>
...
<option value="0">Select Matrimony Profile for</option>
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <select class="selectpicker select_select" name="religion">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" class="input_feild" name="email" id="inputEmail">
    </div>
  </div>
  <div class="control-group">
...
<option value="0">Select A Country</option>
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <select name="cast" class="selectpicker select_select">
    <option></option>
