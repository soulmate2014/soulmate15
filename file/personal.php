...
<div class="navbar-inner">
            ...
            <div class="span3" data-original-title="" title=""></div>
              <ul class="nav">
                ...
                <li style="border:none;"><a href="help.php">HELP</a></li>
              </ul>
              <div class="span3" data-original-title="" title=""></div>
            </div>
          </div>
				...
				<div class="container">
    				<div class="span12">
                         ...
                         <h4>S189856</h4>
                            ...
                            <div class="profile">
                            	<div class="span12">
                                	<div class="span4 "><img src="img/images/sooraj_09.jpg"/></div>
                            		<div class="span8">
                                    <div class="loader1">
                                    	<p><img src="img/images/p1_03.jpg" />   View Mobile No/sms </p>
                                    		
                                      <p> <img src="img/images/p2_03.jpg" />  Request Horoscope</p>    
                                       <h3><br /> Did You Like This Member</h3>
                                       <input type="button" class="btn1 btn-medium match" name="yes" value="yes" />
                                       <input class="btn1 btn-medium match" type="button" value="Not Now" />
                                      <br />
                                       <span class="n">Contact this member directly through Mobile, E-mail and <br />
Chat by upgrading your membership. Upgrade Now</span>
                                     </div>
                                    </div>
								</div> 
                                </div>                           
