...
<!--<script>
function myFunction() {
    document.getElementById("highlite").style.background = "#9FC";
}
</script>-->
								...
								<?php } ?>
                                	<div class="span12" ><!--<input class="check " type="checkbox"> --><div class="v1" style="float:left;"><a href="#"><?php echo $item->name; ?> (<?php echo $item->user_id; ?>)</a></div>
									...
									{
									?>
                                    <div style="width:110px; font-size:11px; float:left; height:20px; background-image:url(<?php echo base_url();?>file/img/featured-profile-package_03.png); background-repeat:no-repeat; margin-left:5px; text-align:center; color:#FFF;"><?php echo $item->package; ?></div>
                                    <?php } ?>
                                 </div>
                                 	<div class="span12">
                                    <div class="span3 view1 ">
                                  <?php if($item->file_name==''&&$item->gender=='male')
									{ ?>
                                    <img class="profile_thumb" src="<?php echo base_url();?>file/img/avtr_men.jpg"  />
                                    <?php } elseif($item->file_name==''&&$item->gender=='female')
									{  ?>
                                    ...
                                    <img class="profile_thumb" src="<?php echo base_url();?>uploads/<?php echo  $item->file_name; ?>"><?php } ?></div>
                            		<div class="span4">
...
<div class="span11">
 <?php if($session_data['status_paid']==2 &&$session_data['gender']==$item->gender){ ?>
                  You can't contact same gender
                  
                  <?php } else if($session_data['status_paid']==2 &&$session_data['gender']!=$item->gender) { ?>
                   <a data-toggle="modal" data-target="#mail<?php echo $i; ?>" href="">
                  <input class="btn1 btn-small match mbtn" type="button" value="Send Mail" />
                  </a>
                 
                  
                   <?php } else if($session_data['status_paid']==0 &&$session_data['gender']!=$item->gender) { ?>
                  ...
                  You can't contact same gender
                  <?php }   if($session_data['status_paid']==0 &&$session_data['gender']==$item->gender){ ?>
       				 ...
       				 <button class="btn">Search</button>
                              ...
                              <div class="matches">
                            	<div class="span12" style="background-color:#FFF; overflow:hidden;">
                                	 <img src="<?php echo base_url(); ?>file/add/individual page.jpg">
