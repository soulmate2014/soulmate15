...
<div class="row-fluid content">
  <div class="container">
    <h5 style="text-align:right; margin-top:20px; margin-bottom:20px;"><a href="<?php echo site_url('horoscope_controller');?>"  >Skip this step >>>>></a></h5>
...
<div class="alert alert-success alert-dismissable" style="margin-top:10px;">
 ...
 Your video introduction has been upload succefully.Now you can set video privacy.... </div>
  <?php } ?>
    ...
    <form enctype="multipart/form-data" action="<?php echo base_url()?>index.php/upload_video/do_upload" method="post">
    <a name="raptors"></a>  
  ...
  <div class="span12">
    <h4 style="font-weight:bold; font-size:16px; color:#656565">Select Your Video Privacy Status</h4>
      ...
      <form action="<?php echo base_url()?>index.php/upload_video/privacy" method="post"></form>
        <form action="<?php echo base_url()?>index.php/upload_video/privacy" method="post">
