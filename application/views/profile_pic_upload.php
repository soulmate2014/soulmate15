...
<div class="row-fluid content">
  <div class="container">
    <h5 style="text-align:right; margin-top:20px; margin-bottom:20px;"><a href="#" id="popup" onClick="div_show()">Skip this step >>>>></a></h5>
...
return false;
    ...
    <div class="modal fade hide" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
      ...
      <div class="modal-body" id="blk">
        <p>Are you sure you want to delete this photo?<?php echo $row->prof_pic ?></p>
      </div>
      <div id="ali"></div>
      <div class="modal-footer">
...
?>
	...
	{?>
     ...
     <!-- <div class="" style="position:relative"><img src="<?php echo base_url();?>file/img/close.png" /></div>-->
        <div class="span12" style="width:237px; overflow:hidden;" ><img src="<?php echo base_url();?>uploads/<?php echo $row->prof_pic; ?>" width="237px" height="224px" /></div>
...
<div class="span3 profpic" style="width:237px; ">
	...
	{?>
       <div class="span3 profpic"  style="width:237px; 	margin-left:125px; ">
        <div class="span12" style="width:237px; overflow:hidden;" ><a href="#raptors"><img src="<?php echo base_url();?>uploads/<?php echo $row->image1; ?>" width="237px" height="224px" /></a></div>
  ...
  <div class="span3 profpic"  style="width:237px; 	margin-left:125px;">
	...
	{?>
       <div class="span3 profpic"  style="width:237px; 	margin-left:125px; ">
        <div class="span12" style="width:237px; overflow:hidden;" ><a href="#raptors"><img src="<?php echo base_url();?>uploads/<?php echo $row->image2; ?>" width="237px" height="224px" /></a></div>
  ...
  <div class="span3 profpic"  style="width:237px; 	margin-left:125px; ">
	...
	{?>
       <div class="span3 profpic"  style="width:237px; 	margin-left:125px; ">
        <div class="span12" style="width:237px; overflow:hidden;" ><a data-toggle="modal" data-target="#myModal" href="index3.html"><img src="<?php echo base_url();?>uploads/<?php echo $row->image3; ?>" width="237px" height="224px" /></a></div>
  ...
  <div class="span12">
    <h4 style="font-weight:bold; font-size:24px; color:#42b8b6">Select an image file on your computer </h4>
      ...
      <input required="required" type="file" name="file_data" />
  ...
  <div class="span12">
    <h4 style="font-weight:bold; font-size:16px; color:#656565">Select Your Photo Privacy Status</h4>
      ...
      <form action="<?php echo base_url()?>index.php/upload_controller/privacy" method="post"></form>
        <form action="<?php echo base_url()?>index.php/upload_controller/privacy" method="post">
  ...
  <div id="popupContact">
    ...
    <form action="#" id="form" method="post" name="form">
      ...
      <p>If you dont add your pictures now,your matches may not
        contact you</p>
      <a href="<?php echo base_url();?>index.php/upload_video/index/5">
