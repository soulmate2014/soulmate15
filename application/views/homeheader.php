...
<script src="<?php echo base_url();?>file/js/my_js.js"></script>
 ...
 {?>
               ...
               <div class="span2 forgot"><input type="text" style="height: 20px;" name="username" class="input-medium email" placeholder="Email/Soulmate ID">
                 &nbsp;<a href="#" id="popup" onClick="div_show()">forgot password?</a> </div>
               <input type="password" style="height: 20px;" name="password1" class="input-medium email" placeholder="Password">
               <button type="submit" class="btn">Log in</button>
 		</form>
        <?php echo form_error('username'); ?><br><?php echo form_error('password1'); ?>
