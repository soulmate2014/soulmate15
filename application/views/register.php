...
function validateForm2() {
	...
	if (phonecode==null || phonecode=="") {
		...
		if (document.forms["frm2"]["mobile"].value.length != 10)
...
<div class=" reg1">
  <div role="tabpanel"> 
    ...
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">LOGIN</a></li>
    </ul>
              ...
              <div class="controls">
                <select class="selectpicker day" style="width:100px; " name="phonecode" >
                  ...
                  <?php
								foreach($country as $count){
									?>
                  <option value="<?php echo $count->phonecode;?>"><?php echo"+"; echo $count->phonecode;?></option>
                  <?php
								}
								?>
                </select>
    ...
    <div role="tabpanel" class="tab-pane" id="messages">
      <div class="span4 ">
      <br />
      <form class="form-horizontal" action="<?php echo base_url();?>index.php/verifylogin" method="post" >
        <div class="span5" style="margin-left:0px;">
       <div class="control-group">
            <label class="control-label" for="inputEmail">Email <span class="dt">:</span></label>
            <div class="controls">
        ...
        <div class="control-group">
        <button type="submit"  class="btn1 btn-large ">LOGIN </button>
      </form>
      <div class="controls"> </div>
    </div>
  </div>
