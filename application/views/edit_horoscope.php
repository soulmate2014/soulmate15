...
<div class="row-fluid content">
  <div class="container">
    <h5 style="text-align:right; margin-top:20px; margin-bottom:20px;">&nbsp;</h5>
...
<!-- Modal -->
    ...
    <script src="app.js"></script>
     ...
     <div class="span12 profupload" style="margin-left:0px;">
      <h4 class="prhd1">MANAGE HOROSCOPE</h4>
</div>
...
<?php foreach($result as $res){
  ...
  ?>
    ...
    <form enctype="multipart/form-data" action="<?php echo base_url()?>index.php/horoscope_controller/edit" method="post">
    <a name="raptors"></a>  
  ...
  <div class="span12">
    ...
    <span style="color:#F00;"><?php if(isset($error)){echo $error;}?></span>
      ...
      <input type="hidden" name="horoscope"  value="<?php echo $res->horoscope;?>" />
  ...
  <?php if($res->horoscope!=""){?>

    <img src="<?php echo base_url()?>/horoscope/<?php echo $res->horoscope;?>" width="350px" height="350px" />
    <?php   }?>
    </div>
