<?php class Gallery1 extends CI_Controller {
    ...
    function index() {
        if(isset($_FILES['file_data'])){
           ...
           $cropped_name = $file_name;   //generate thumbnail to expected width and height
            ...
            redirect('gallery1/crop/'. $cropped_name);
        } else {
...
$this->image_lib->watermark();
           # $this->image_lib->initialize($config);
			...
			$config3['source_image']	= $des_path2;
$config3['wm_text'] = 'Soulmate';
$config3['wm_type'] = 'text';
$config3['wm_font_path'] = './system/fonts/texb.ttf';
